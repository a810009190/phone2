  ...
  <div>
    <div class="container">
      <div class="panel">
        ...
        <el-table :data="currentList.filter(data => !search || data.displayName.toLowerCase().includes(search.toLowerCase()))"
          max-height="730px" border style="width: 100%">
          ...
          <el-table-column prop="isSuccess" label="提取情况" min-width="13%" align="center" sortable>
            <template slot-scope="scope"><span :class="delCss(scope.row.isSuccess)">{{scope.row.isSuccess | toChinese}}</span></template>
          </el-table-column>

          <el-table-column prop="recordVersion" label="提取版本" min-width="12%" align="center">
          </el-table-column>
          <el-table-column prop="remark" label="备注" min-width="12%" align="center">
            </el-table-column>
        </el-table>
      </div>
    </div>
